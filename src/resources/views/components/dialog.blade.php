        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-5">
                ...
                <div class="text-center mt-5">
                    <button type="button" class="btn {{ $dismissStyle ?? 'btn-outline'}} cf-button mr-2 {{ $dismissClass ?? '' }}" data-dismiss="modal" data-modal-dismiss></button>
                    <button type="button" class="btn btn-danger cf-button ml-2 {{ $dialogContClass ?? '' }}" data-ajax-button data-modal-continue></button>
                </div>
            </div>
        </div>
    </div>
